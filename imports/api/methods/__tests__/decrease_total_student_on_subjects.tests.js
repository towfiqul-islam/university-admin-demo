...
if (Meteor.isServer) {
  describe('method: decrease_total_student_on_subjects', function () {
    ...
    it('can decrease total_students count to a given subject', function () {
      ...
      // Invoke updateSubject with newly inserted subject's name which is an array. Because a single student can have multiple subjects and both subjects need to be updated
